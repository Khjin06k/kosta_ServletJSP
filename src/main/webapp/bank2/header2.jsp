...
<div class="outerDiv">
    ...
    <div class="innerDiv">
        <div style="float: left; margin-right:10px;">
            ...
            <a href="makeAccount2.jsp"> 계좌개설 </a>
            <a href="deposit2.jsp"> 입금 </a>
            <a href="withdraw2.jsp"> 출금 </a>
            <a href="accountInfo2.jsp"> 계좌조회 </a>
            <a href="allAccountInfo2.jsp"> 전체계좌조회 </a>
        </div>
        <div style="float: right; margin-right:10px">
            <% if(id==null) {%>
            <a href="login2.jsp"> 로그인 </a>
            <%}else{ %>
            <%=id %> 님 환영합니다. <a href="logOut2.jsp"> 로그아웃 </a>
            <% } %>
            <a href="signup2.jsp"> 회원가입 </a>
        </div>
    </div>
</div>
